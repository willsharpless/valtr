...
def main():
    ...
    t_start = -5.0
    sol, full_dag_path, switch_times = construct_optimal_path(dag_builder, dict_vars, value_tree_grads, t_start, x_start, dag_root, grid, dyn, times=times, tv=False, reaching_eps=0.01)
